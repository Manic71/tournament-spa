...
export default function ViewerPage() {
  ...
  return (
    <div className="space-y-3 pb-8 -mx-4">
      ...
      {/* Schedule table */}
      {games.length === 0 ? (
        <div className="mx-4 rounded-xl border border-slate-200 bg-white p-6 text-center text-slate-400 text-sm">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-xs font-semibold uppercase tracking-wide text-slate-500">
                <th className="px-2 py-2.5 text-center w-8">Rd</th>
                <th className="px-2 py-2.5 text-left w-14">Zeit</th>
                <th className="px-2 py-2.5 text-center w-8">Feld</th>
                <th className="px-2 py-2.5 text-left">Gegner</th>
                <th className="px-2 py-2.5 text-center w-8">H/G</th>
              </tr>
            </thead>
              ...
              {games.map((game, i) => {
                ...
                return (
                  <tr key={i} className="hover:bg-slate-50 transition-colors">
                    <td className="px-2 py-3 text-center font-semibold text-slate-700">{game.round}</td>
                    <td className="px-2 py-3 text-slate-600 tabular-nums whitespace-nowrap">{game.time}</td>
                    <td className="px-2 py-3 text-center font-medium text-slate-700">{fieldShort}</td>
                    <td className="px-2 py-3 text-slate-800 font-medium">{opponent}</td>
